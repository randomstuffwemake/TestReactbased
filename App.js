...
import { connectSerial, sendSerialData } from './serial'; // Assuming you have these functions in webSerial.js
    ...
    async function loop() {
      ...
      if(hands.multiHandLandmarks) {
        ...
        if(exampleAdded) {
          ...
          sendSerialData(labelAI); // Replace sendData with sendSerialData
        }
      }
  ...
  return (
    <div className="App">
      <header className="App-header">
        <button className="button-37" role="button" onClick={connectSerial}>Connect to Serial</button>
